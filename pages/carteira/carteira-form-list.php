            ...
            <div class="modal-body">
               ...
               <div class="row">
                  ...
                  <div class="col-6">
                     <div class="form-group">
                        <label>Nome</label>
                        <input style="text-transform:uppercase" type="text" class="form-control" name="nome" id="entregador">
                     </div>
                  </div>
                  <div class="col-6">
                     <div class="form-group">
                        <label>Nome de guerra</label>
                        <input style="text-transform:uppercase" type="text" class="form-control" name="apelido" id="apelido">
                     </div>
                  </div>
                  <div class="col-6">
                     <div class="form-group">
                        <label>CPF</label>
                        <input style="text-transform:uppercase" type="text" class="form-control" name="cpf" id="cpf">
                     </div>
                  </div>
                  ...
                  <div class="col-6">
                     <div class="form-group">
                        <label>Telefone</label>
                        <input style="text-transform:uppercase" type="text" class="form-control" name="telefone" id="telefone">
                     </div>
                  </div>
                  <div class="col-4">
                     <div class="form-group">
                        <label>Email</label>
                        <input style="text-transform:uppercase" type="text" class="form-control" name="email" id="email">
                     </div>
                  </div>
                  ...
                  <div class="col-6">
                     <div class="form-group">
                        <label>Cnh</label>
                        <input style="text-transform:uppercase" type="text" class="form-control" name="cnh" id="cnh">
                     </div>
                  </div>
                  <div class="col-6">
                     <div class="form-group">
                        <label>Renavam</label>
                        <input style="text-transform:uppercase" type="text" class="form-control" name="renavam" id="renavam">
                     </div>
                  </div>
                  ...
                  <div class="col-3">
                     <div class="form-group">
                        <label>Banco</label>
                        <input style="text-transform:uppercase" type="text" class="form-control" name="banco" id="banco">
                     </div>
                  </div>
                  <div class="col-3">
                     <div class="form-group">
                        <label>Agência</label>
                        <input style="text-transform:uppercase" type="text" class="form-control" name="agencia" id="agencia">
                     </div>
                  </div>
                  <div class="col-4">
                     <div class="form-group">
                        <label>Conta</label>
                        <input style="text-transform:uppercase" type="text" class="form-control" name="conta" id="conta">
                     </div>
                  </div>
                  ...
                  <div class="col-4">
                     <div class="form-group">
                        <label>Chave pix</label>
                        <input style="text-transform:uppercase" type="text" class="form-control" name="pix" id="pix">
                     </div>
                  </div>
