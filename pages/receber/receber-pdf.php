...
<body>
    ...
    <table>
        <tbody>
           ...
           <tr style="background-color:#fff; color:#000; ">
                <td style="text-align: center; text-transform:uppercase; font-size:15px;border-color:1px solid #fff;">CLIENTE: </td>
                <td style="text-align: lefet; text-transform:uppercase; font-size:15px;border-color:1px solid #fff;" colspan="5"><?= $cli ?></td>
            </tr>
