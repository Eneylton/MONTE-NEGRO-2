...
if($_GET['clientes_id'] == ""){
    ...
    $consulta = " AND r.data BETWEEN ' $inicio ' AND ' $fim '";
    ...
    INNER JOIN
    setores AS st ON (cli.setores_id = st.id)', $cliente. $consulta. ' group by mes' ,'r.data ASC',null);
    ...
    INNER JOIN
    clientes AS c ON (r.clientes_id = c.id)', $cliente. $consulta. ' group by mes' ,'r.data ASC',null);
    ...
    INNER JOIN
    ocorrencias AS o ON (d.ocorrencias_id = o.id)', $cliente. $consulta. ' group by o.nome' ,'r.data ASC',null);
    ...
    clientes AS c ON (r.clientes_id = c.id)
    INNER JOIN
    entregadores AS et ON (e.entregadores_id = et.id)', $cliente. $consulta. ' group by et.apelido' ,'r.data ASC',null);
    ...
    clientes AS c ON (r.clientes_id = c.id)
    INNER JOIN
    setores AS st ON (sv.setores_id = st.id)', $cliente. $consulta. ' group by sv.nome' ,'r.data ASC',null);
